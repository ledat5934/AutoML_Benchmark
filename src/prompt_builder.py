...
class PromptBuilder:
    ...
    def _stage_instructions(self, stage: int, project: ProjectInfo) -> str:
        ...
        dataset_json_filename = f"{project.name}.json"
        pathlib_instruction = (
            ...
            f"Define `METADATA_JSON_PATH = (BASE_PATH / '{dataset_json_filename}').resolve()` – this is the dataset metadata generated by the pipeline. **Never hard-code to '/kaggle/*.json'**.\n"
